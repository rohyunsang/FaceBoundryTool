...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UILineRenderer : UIPrimitiveBase
	{
        ...
        [SerializeField, Tooltip("Connect the start and end points to form a loop")]
        ...
        public Vector2[] Points
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    if (m_loop)
                    {
                        List<Vector2> loopedList = m_points.ToList();
                        loopedList.Add(m_points[0]);
                        m_points = loopedList.ToArray();
                    }
                }
                SetAllDirty();
            }
